...
namespace Student1.Controllers
{
    public class LendingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Lending,Account_No,ID_Customer")] Lending lending)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Lending,Account_No,ID_Customer")] Lending lending)
        {
            if (ModelState.IsValid)
            {
